    ...
    <view class="ylx-navbar-wrap" :style="navbarStyle_">
      <view class="navbar-content__container">
        <view class="ylx-navbar-container" :style="ylxNavbarContainerStyle">
          ...
          <view class="ylx-navbar-container__center" :style="`justify-content:${justifyContent}`">
            <slot name="center">
...
export default {
  ...
  computed: {
    ...
    navbarHeight() {
      ...
      this.$emit('navbarInfo', {navbar: navbarH, loadedPages: pages, statusBar: this.statusBarHeight})
