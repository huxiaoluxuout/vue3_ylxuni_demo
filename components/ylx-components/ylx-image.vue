  ...
  props: {
    ...
    mode: {
      ...
      validator: function (value) {
        return ['widthFix', 'aspectFill', 'heightFix', 'scaleToFill','center'].includes(value);
      },
      default: 'aspectFill'
    },
